...
This security policy applies to all pmux open-source components.
...
Instead, report vulnerabilities via email to **hello@shiftinbits.com** with "SECURITY" in the subject line.
